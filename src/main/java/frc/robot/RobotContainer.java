...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        // X (hold): transfer to holding (hopper manual forward)
        operatorController.x()
            .whileTrue(
                new StartEndCommand(
                    () -> {
                        intakeHopperSubsystem.requestMode(IntakeHopperSubsystem.Mode.HOPPER_MANUAL);
                        intakeHopperSubsystem.setHopperManualPower(Constants.TRANSFER_TO_HOLDING_HOPPER_POWER);
                    },
                    intakeHopperSubsystem::stop,
                    intakeHopperSubsystem
                )
