...
public final class Constants {
	...
	public static final int LAUNCHER_CURRENT_LIMIT_AMPS = 50;
	...
	// ============================
	//public static final double DRIVE_POWER_R = 0.9;
	//public static final double DRIVE_POWER_L = 0.7; 
	// Split drivetrain max power for left/right
	public static final double LEFT_DRIVETRAIN_MAX_POWER = 0.85;
	public static final double RIGHT_DRIVETRAIN_MAX_POWER = 0.9;
